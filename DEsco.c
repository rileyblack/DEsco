...
void modeTwo(){
	...
	*(LOWHEXptr) = 0x6E6D005B;							//sets last 4 seven segments to 'S 2'
	...
	volatile int increasing1 = 1;							//variable containing logic of increasing or decreasing part of pattern in pattern 1 
	volatile int currpos1 = 0;							//variable containing logic of current LED wanted to manipulate in pattern 1
	volatile int currpos2 = 9;							//variable containing logic of another current LED wanted to manipulate in pattern 1
	...
	volatile int increasing3 = 1;							//variable containing logic of increasing or decreasing part of pattern in pattern 3 
	volatile int currpos3 = 0;							//variable containing logic of current LED wanted to manipulate in pattern 3
	volatile int on3 = 1;								//variable containing logic of turning on or turning off part of pattern in pattern 3
